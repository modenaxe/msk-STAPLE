...
function [Z0, Y0] = fitQuadriTalus(Tr, V_all, debug_plots)
	...
	% ----------
	% Tr : triangulation
	% 	The triangulation object of the Talus
	% V_all : [3x3] float matrix
	% 	The eigen vector of the inertia matrix of Talus
	% debug_plots : boolean
	% 	Optionnal argument to plot the fit
	%
	% Returns
	% -------
	% Z0 : [3x1] float vector
	% 	A vector 
	% Y0 : __TYPE__
	% 	A vector [3x1] of the medial to lateral (or the other way
	% 	 around) directio
	%
	%
