...
function [ TibiaElmtsIDOK ] = ankleSurfFit( TR_AnkleSurf, TR_Tibia, V )
	...
	% Parameters
	% ----------
	% TR_AnkleSurf : triangulation
	% 	An initial estimation of the inferior articular
	% 	 surface of the tibia
	% TR_Tibia : triangulation
	% 	The geometry of the distal tibia.
	% V : [3x3] float matrix
	% 	The eigen vectors of the pseudo inertia-matrix of the whole tibia.
	%
	% Returns
	% -------
	% TibiaElmtsIDOK : __TYPE__
	% 	Element Id of all elements from TR_Tibia identified to
	% 	 be part of the updated inferior articular surface
	%
	%
