% PLOTELLIPSOID Plot an ellipsoid on the current axis.
% This plot a volumetric ellipsoid.
%
% plotEllipsoid( centers, radius, color, alpha )
%
% Inputs:
%   centre - Center point of the ellipsoid to plot.
%   radii - The 3 radii of the ellipsoid.
%   evecs - The matrix of principal direction of the ellipsoid.
