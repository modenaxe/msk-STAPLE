...
%       roperties.onMeshCenter - Closest point to Properties.Center in 
%                                the triangulation.
% ------------------------------------------------------------------------%
...
function [ Properties ] = TriMesh2DProperties( TR )
    ...
    meanNormalDirVec =  sum(TR.faceNormal.*repmat(Properties.Area, 1, 3), 1)/Properties.TotalArea;
    Properties.meanNormal = meanNormalDirVec'/norm(meanNormalDirVec);
