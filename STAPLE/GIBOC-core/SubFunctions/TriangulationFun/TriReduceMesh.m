...
function [ TRout ] = TriReduceMesh( TR, ElmtsKept, NodesKept )
    % Case when Nodes ID are passed to make the reduction
    % First step is to find the associated elements Id
    if nargin >2
    ...
    % Elements Id are known. A subset of TR is performed
    % from those elements Id.
