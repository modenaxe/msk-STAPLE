...
%   d - A scalar such that if a point P of the plan, OP.n = -d
%     - A [3x1] or [1x3] coordinate of a point on the plan.
%   debug_plots - A boolean, if set to true a plot of the intersection will be made
%   
% Outputs :
