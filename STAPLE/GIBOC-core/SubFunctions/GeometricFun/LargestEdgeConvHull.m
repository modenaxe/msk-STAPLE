...
%
% [ IdxPointsPair , EdgesLength , K, Edges_Length_and_VerticesIDs_sorted] 
%                                    = LargestEdgeConvHull(Pts, Minertia)
%
% Inputs:
%   Pts - A Points Cloud in 2D [nx2] or 3D [nx3]
...
%                                                edges length and the last two
%                                                columns corresponding to the 
%                                                Index of the points forming 
%                                                the edge.
%
% -------------------------------------------------------------------------
