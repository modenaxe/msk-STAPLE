...
if isfield(JCS, femur_name)
    thigh_axis = JCS.(femur_name).(hip_name).Origin-...
                 JCS.(femur_name).(knee_name).Origin;
    ...
    if isfield(JCS, talus_name)
        shank_axis = JCS.(femur_name).(knee_name).Origin...
                    -JCS.(talus_name).(ankle_name).Origin';
        ...
        if isfield(JCS, calcn_name)
            foot_axis = JCS.(talus_name).(ankle_name).Origin'...
                        -JCS.(calcn_name).(toes_name).Origin;
