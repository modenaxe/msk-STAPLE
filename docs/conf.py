...
staple_path = os.path.abspath('../STAPLE')
sys.path.insert(0, staple_path)
...
matlab_src_dir = os.path.dirname(staple_path)
primary_domain = 'mat'
...
html_logo = './assets/images/logos/logo_single_s.png'
