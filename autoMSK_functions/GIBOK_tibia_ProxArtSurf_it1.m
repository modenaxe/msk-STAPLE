function EpiTibAS = GIBOK_tibia_ProxArtSurf_it1(ProxTib, EpiTib, EpiTibAS, CSs, Ztp , oLSP, CoeffMorpho)
...
EpiTibCenterRidgeMed = GIBOK_tibia_removePartBetweenRidges_it1(ProxTib, EpiTib, CSs, CoeffMorpho, ELP1, Ztp , 'medial');
EpiTibCenterRidgeLat = GIBOK_tibia_removePartBetweenRidges_it1(ProxTib, EpiTib, CSs, CoeffMorpho, ELP1, Ztp , 'lateral');
