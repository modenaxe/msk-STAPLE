function [ PtsCondyle_end, PtsKeptID ] = PtsOnCondylesFemur( PtsCondyle_0 , Pts_Epiphysis, CutAngle, InSetRatio )
...
ellipse_x_r     = Elps.X0 + coef*Elps.a*cos( theta_r );
ellipse_y_r     = Elps.Y0 + coef*Elps.b*sin( theta_r );
...
IN_CH = inpolygon(Pts_Epiphysis(:,3),Pts_Epiphysis(:,1),...
    PtsCondyle_0(K,3)+0.025*(PtsCondyle_0(K,3)-Elps.X0_in),...
    PtsCondyle_0(K,1)+0.025*(PtsCondyle_0(K,1)-Elps.Y0_in));
