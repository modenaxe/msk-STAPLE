...
datasets_folder = 'Modenese_Bones';
...
bones_list = {'pelvis_no_sacrum', 'femur_l'};
...
%     tri_folder = fullfile(datasets_folder, cur_dataset, 'tri');
    tri_folder = fullfile(datasets_folder, cur_dataset, 'stl');
    ...
    %% Add JCs to BL list - Riad 16.02.21 
    %BL = AddJCs2BL(BL, JCS, cur_side);
